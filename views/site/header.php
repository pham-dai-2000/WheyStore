<img src="upload/qc.png" width="1100px" >
<div class="row" style="margin-top: 8px;height: 110px">
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 clearpadding">
				<a href="#"><img style="max-height: 160px;width: 60%" src="<?php echo base_url(); ?>public/upload/logo.png" alt="" class="img-responsive"></a>
			</div>
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 clearpadding">
				<a href="#"><img style="max-height: 100px;width: 100%" src="<?php echo base_url(); ?>public/upload/banner2.jpg" alt="" class="img-responsive"></a>
			</div>
		</div>
		<div class="row">
			          ...
			          <?php foreach ($catalog as $value)
			           {
			            ...
			            ?>
			          	<li><a style="color: #FA8072;padding: 10px 20px;" href="<?php echo base_url($name.'-c'.$value->id); ?>"><?php echo $value->name; ?></a></li>
			          <?php } ?>
			          </ul>
			        </li>
